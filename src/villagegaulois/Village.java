...
public class Village {
	...
	public String installerVendeur(Gaulois vendeur, String produit, int nbProduit) {
		...
		if (numeroEtal == 0) {
			...
			chaine.append(
					"Le vendeur " + vendeur.getNom() + " vend des " + produit + "à l'étal n°" + numeroEtal + ".\n");
		}
		return chaine.toString();
	}
	...
	public String rechercherVendeursProduit(String produit) {
		...
		if (etalProd[0] == null) {
			...
			chaine.append(
					"Seul le vendeur " + etalProd[0].getVendeur().getNom() + "propose des " + produit + " au marché.");
		} else {
	...
	public String partirVendeur(Gaulois vendeur) {
		...
		if (etal != null) {
			...
			chaine.append(vendeur.getNom() + " quitte son étal, il a vendu " + quantiteVendue + " "
					+ etal.getProduit() + " parmi les " + quantiteInitiale + " qu'il voulait vendre.\n");
		} else {
	...
	public String afficherMarche() {
		...
		for (Etal etal : marche.tabEtal) {
			if (etal.isEtalOccupe()) {
				chaine.append(
						etal.getVendeur().getNom() + " vend " + etal.getQuantite() + " " + etal.getProduit() + "\n");
			} else {
				nbEtalVide++;
			}
		}
	...
	private class Marche {
		...
		private Etal trouverVendeur(Gaulois gaulois) {
			for (int i = 0; i < tabEtal.length; i++) {
				Gaulois vendeur = tabEtal[i].getVendeur();
	...
	//TODO sortir de la classe + reprendre les bonnes pratiques sur les exceptions personnalisée
